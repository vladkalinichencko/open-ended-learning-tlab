...
Реализовать её до конца я не успел. Там нужно решить, сколько кадров брать в окно, чтобы поймать зависимость «было до, стало после, какие условия, какое неверное действие», и сопоставление окон между собой оказалось нетривиальным. В итоге сделана только базовая диагностика.
